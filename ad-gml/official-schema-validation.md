...
* Validate each document against the latest INSPIRE official schema(s): https://inspire.ec.europa.eu/schemas/ad/4.0/Addresses.xsd, using strict XML schema validation.
